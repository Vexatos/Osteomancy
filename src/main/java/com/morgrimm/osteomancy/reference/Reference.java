...
public class Reference {
    public static final String MOD_NAME = "Osteomancy";
    public static final String MOD_ID = "osteomancy";
    public static final String VERSION = "1.7.10-1.0";
    public static final String NETWORK_CHANNEL_NAME = MOD_ID.toLowerCase();
